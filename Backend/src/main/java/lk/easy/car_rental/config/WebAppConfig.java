...
@Configuration
@EnableWebMvc
@ComponentScan(basePackageClasses = {CustomerController.class, CarController.class, ManageLoginController.class, DriverController.class, AppWideExceptionHandler.class})
